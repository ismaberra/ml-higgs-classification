...
(feature 0 = Id , so we should shift every idx by 1)
...
During exploratory analysis, we found that feature BPHIGH4 (idx 35) (high blood pressure diagnosis) is coded as 1=Yes, 3=No, 7/9=Unknown.
